 ...
 *
 * Service connections, baseline management,
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Configuration, connections, and baseline management
          </p>
        </div>
        ...
        <div
          ...
          role="status"
          aria-label={`System status: ${connectedCount} of 4 services connected`}
        >
          <div
            className={`w-3 h-3 rounded-full ${connectedCount === 4
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">{connectedCount}/4 services connected</p>
          </div>
        </div>
      </div>
      ...
      <section aria-labelledby="baseline-heading">
        <div className="mb-4">
          <h2 id="baseline-heading" className="text-xl font-bold text-white">
            Baseline Management
          </h2>
          <p className="text-sm text-slate-500 mt-1">
            Configure anomaly detection thresholds and model parameters
          </p>
        </div>
        <BaselineManagement />
      </section>
      ...
      {/* Demo Mode Section */}
      <section aria-labelledby="demo-mode-heading">
        <Card title={<span id="demo-mode-heading" className="telemetry-label">Demo Mode</span>}>
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-white font-medium">
                  Mock Mode {mockMode ? 'Active' : 'Inactive'}
                </p>
              </div>
              <p className="text-sm text-slate-500">
                {mockMode
                  ? 'Displaying simulated demo data. All dashboards show realistic mock devices and anomalies.'
                  : 'Enable to display simulated data for testing and demonstrations without requiring live database connections.'
                }
              </p>
            </div>
          </div>
